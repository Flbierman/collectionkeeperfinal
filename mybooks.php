...
<div class="container">
    <!-- Add to Books Section -->
    <form id="booksForm" method="post" action="mybooks.php">
        <div class="container-form1">
            <fieldset>
                <legend>Add to Books</legend>
                <div>
        ...
        <div class="container-form1" id="search-container">
            <fieldset>
                ...
                <div>
                    ...
                    <input type="text" id="search-title" onkeyup="filterBooks()">
                </div>
            </fieldset>
        </div>
    </form>
...
function showDetails(title, location) {
    ...
    const url = `https://www.googleapis.com/books/v1/volumes?q=${normalizedTitle}&key=${GOOGLE_BOOKS_API_KEY}`;
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.totalItems === 0) {
                ...
                displayDetails(title, location, book, true);
            }
        })
...
function filterBooks() {
    ...
    const mediaItems = booksContainer.getElementsByClassName('media-item');
...
// Function to filter books by first letter
...
<div class="chatbox-container" id="chatbox-container">
    ...
    <div id="chatbox">
        ...
        <div id="chat-input-container">
            <input type="text" id="chat-input" placeholder="Ask the AI about books...">
